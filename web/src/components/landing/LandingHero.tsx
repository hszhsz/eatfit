        ...
        <div className="grid gap-4">
          <div className="rounded-[24px] border border-[#F0E6DD] bg-white p-6 shadow-warm">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="mt-3 font-serif text-3xl text-[#1F1611]">{t("hero.board.target")}</div>
              </div>
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              {[
                [t("hero.board.protein"), "142 g"],
                [t("hero.board.carbs"), "231 g"],
                [t("hero.board.fat"), "63 g"],
              ].map(([label, value]) => (
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-[24px] border border-[#F0E6DD] bg-white p-5 shadow-warm">
              <div className="text-xs uppercase tracking-[0.24em] text-[#9C8B7A]">{t("hero.board.quality")}</div>
              <div className="mt-3 text-4xl font-semibold text-[#1F1611]">92</div>
              <p className="mt-2 text-sm leading-6 text-[#6B5544]">
                {t("hero.board.qualityDesc")}
              </p>
            </div>
            <div className="rounded-[24px] border border-[#F0E6DD] bg-white p-5 shadow-warm">
              <div className="text-xs uppercase tracking-[0.24em] text-[#9C8B7A]">{t("hero.board.flow")}</div>
              <ul className="mt-3 space-y-3 text-sm text-[#6B5544]">
                <li>{t("hero.board.flow1")}</li>
                <li>{t("hero.board.flow2")}</li>
                <li>{t("hero.board.flow3")}</li>
              </ul>
            </div>
          </div>
        </div>
